...
ggplot(data=new_avg_steps_at_time,aes(x=times2, y=steps, group=1))+geom_line()+facet_grid(wDay ~ .)+scale_x_datetime(labels = date_format("%H:%M"))+facet_grid(wDay ~ .)+ggtitle("Average Steps per 5 min Interval on Weekends and Weekdasy")+ylab("Time of Day")+xlab("Avg Number of Steps")
```
